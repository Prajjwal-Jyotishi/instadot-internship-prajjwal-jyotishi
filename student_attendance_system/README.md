...
├── test_smoke.py   # End-to-end verification test
...
- Non-existent student/record gives clear error message
...
![Register and Search](screenshots/output_1_register_search.png)

### 2. List Students & Delete Student
![List and Delete](screenshots/output_2_list_delete.png)

### 3. Register Again & Mark Attendance
![Register and Mark Attendance](screenshots/output_3_register_mark.png)

### 4. Update Attendance & Attendance Percentage
![Update and Percentage](screenshots/output_4_update_percentage.png)

### 5. Attendance Percentage & Monthly Report
![Percentage and Monthly Report](screenshots/output_5_percentage_report.png)

### 6. Monthly Report & Auto Background Report on Exit
![Monthly Report and Exit](screenshots/output_6_report_exit.png)
